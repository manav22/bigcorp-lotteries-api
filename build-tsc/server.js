    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!id) {
                    return [2 /*return*/, res.status(400).json({ error: "Missing required field: ".concat(requiredFieldId) })];
                }
                if (!name) {
                    return [2 /*return*/, res.status(400).json({ error: "Missing required field: ".concat(requiredFieldName) })];
                }
                _b.label = 1;
            case 1:
                _b.trys.push([1, 4, , 5]);
            ...
            case 4:
                ...
                if (error_2 instanceof Error) {
                    ...
                    res
                        .status(500)
                        .json({ error: "Failed to register for the lottery: ".concat(error_2.message) });
                }
                return [3 /*break*/, 5];
...
app.get("/lotteries", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _b = (_a = res).json;
                return [4 /*yield*/, getAllLotteries()];
            case 1:
                _b.apply(_a, [_c.sent()]);
                return [2 /*return*/];
        }
...
function getAllLotteries() {
    return __awaiter(this, void 0, void 0, function () {
        var res, lotteries, lotteryIds, transaction_1, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
